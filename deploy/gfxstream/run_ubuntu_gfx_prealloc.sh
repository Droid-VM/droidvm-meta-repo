#!/system/bin/sh
# Manual crosvm launch for the ubuntu VM in GFXSTREAM PRE-ALLOC mode (host-visible blobs sub-allocated from a boot-blessed GpuPool memfd; no runtime SHARE).
...
# accept SHARE (host-visible blobs). Validates the attach_shared_region fold on
