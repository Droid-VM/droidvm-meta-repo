...
- Build with the repo scripts from the meta root
  (`/root/gitrs/DroidVM/DroidVM_3daccel_gfxstream`): `bash 2_build_crosvm.sh`
...
On 5568 (adb 172.22.74.2:5568), u26 VM reconfigured to a VNC screen with the gpu-hw
...
- crosvm checkout: `/root/gitrs/DroidVM/DroidVM_3daccel_gfxstream/crosvm` (symlink into
