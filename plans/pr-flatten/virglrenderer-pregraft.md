...
Repo: `/root/gitrs/DroidVM/DroidVM_3daccel_gfxstream/crosvm_build/external/virglrenderer` (remote `droidvm` = Droid-VM/virglrenderer). Clone is now unshallowed, so the old graft point f6a66611 and everything below it is inspectable.
