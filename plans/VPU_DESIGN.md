...
**目前的部署版本（2026-09-18，手機 App 路徑上跑的就是這一組）。** crosvm fork `wip/vpu` **`9d6fe4983`** ＋ virtio-media fork `wip/vpu` **`74a1dce`**（App 路徑 md5 `ca29fec12fe3a39938dbad9fc89ee2cd`，`P6b-deploy` 部署；前兩版 `002659f6…`／`6b1b8c41…` 留在 `/data/local/tmp/crosvm_002659f6_backup_p6b`／`crosvm_6b1b8c41_backup_d91`）、libva-v4l2 **r426 `ad0492f`**（`.so` md5 `bf9aa557f4e0a03a5ea8eab429388b19`；wip/vpu `26eb183` 的樹與它相同）、mesa fork `wip/vpu` **`4b23362ebfe`**（`mesa-guest` r227673，zink 那一行）、guest-additions **r25**。guest-additions **r26 `329503a`**（P-1 的 greeter 備援底色 drop-in，§7.8；`P1-verify` 在新增量碟上驗過）。
